...
<div class="container" align="center">
    ...
    <form action="./signUp" method="POST" role="form">
        <div class="form-group">
            ...
            <input type="name" class="form-control" id="name" placeholder=<fmt:message key="library.field.enter.name" bundle="${bundle}" /> name="name">
        </div>
        <div class="form-group">
        ...
        <div>
            ...
            <label for="role"><fmt:message key="registration.role" bundle="${bundle}"/></label><br/>
            <select
    ...
    <c:if test="${not empty users_id}">
        <div class="alert alert-success">
            <fmt:message key="library.users_id" bundle="${bundle}"/>: "${users_id}".
        </div>
    </c:if>
</div>
